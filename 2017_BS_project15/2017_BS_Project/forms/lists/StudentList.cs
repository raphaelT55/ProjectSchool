    ...
    public partial class StudentList : Form
    {
        ...
        private void DataLoad()
        {
            try
            {
                ...
                var select = "SELECT idNUmber,fname,lname,email,password, id FROM users WHERE type = 5 ORDER by id DESC";
        ...
        private void add_new_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                addStudent(fname.Text, lname.Text, email.Text, password.Text, IdNumber.Text, 5);
                DataLoad();
            }
            else
